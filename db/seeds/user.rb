...
User.create!(
  [
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/mercury.jpg'),
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/venus.jpg'),
	password: 'venusvenus',
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/earth.jpg'),
	password: 'earthearth',
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/jupiter.jpg'),
	password: 'jupiter',
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/saturn.jpg'),
	password: 'saturn',
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/uranus.jpg'),
	password: 'uranus',
	...
	profile_img: File.open('#{Rails.root}/app/assets/images/profile_img/neptune.jpg'),
	password: 'neptune',
